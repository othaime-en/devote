...
contract DecentralizedVoting2 {
    ...
    function createInstance(
        ...
        instance.startTime = _startTime;
        instance.endTime = _endTime;
    ...
    function startVoting(uint256 _instanceId) public {
        require(_instanceId <= instanceId, "Invalid instance ID");
        VotingInstance storage instance = instances[_instanceId];
        require(
            msg.sender == instance.creator,
    ...
    function vote(uint256 _instanceId, uint256 _candidateId) public {
        ...
        require(
            instance.isVotingStarted,
            "Voting has not started for this instance"
        );
        require(
            block.timestamp >= instance.startTime,
            "Voting has not started yet"
        ...
        require(block.timestamp < instance.endTime, "Voting has already ended");
        require(
            !_hasVoted(instance.hasVoted[msg.sender]),
    ...
    function _hasVoted(bool _voted) private pure returns (bool) {
        return _voted;
    }
}
